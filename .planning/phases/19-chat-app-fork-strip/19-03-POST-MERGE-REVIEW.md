...
| H9 | Real Supabase project URL in `.env.example` | code | `.env.example:10,14,15,87,95` | `yimgflllgdsbcibnaxqe.supabase.co` appears five times as a non-empty default. Fork or public mirror exposes prod project ref. |
