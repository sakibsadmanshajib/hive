...
# DEPRECATED - LibreChat upstream version pin

> Superseded on 2026-05-17 by the Open WebUI pivot. Hive Chat no longer vendors LibreChat. Keep this file only as historical context for the rejected v3 plan.

Hive chat-app (`apps/chat-app/`) is a vendored fork of LibreChat at the tag + SHA above.

Upgrade procedure: see [`LIBRECHAT-UPGRADE-PLAYBOOK.DEPRECATED.md`](./LIBRECHAT-UPGRADE-PLAYBOOK.DEPRECATED.md).
