...
# DEPRECATED - Chat-App Base License & Hosting Decision

> Superseded on 2026-05-17 by the Open WebUI pivot. The active decision is upstream Open WebUI image consumption, not a LibreChat fork. Keep this file only as historical context for the rejected v3 plan.
