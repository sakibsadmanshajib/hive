...
// that never told an operator anything happened, alongside images's identical
...
func TestRoutingAdapterLogsAccountNotProvisioned(t *testing.T) {
	...
	adapter := audio.NewRoutingAdapter(inference.NewRoutingClient("http://unused.invalid"))
