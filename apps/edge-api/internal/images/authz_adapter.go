...
// AuthorizerAdapter adapts authz.Authorizer to the images.Authorizer interface.
type AuthorizerAdapter struct {
	inner *authz.Authorizer
}

// NewAuthorizerAdapter wraps an authz.Authorizer for use with the images Handler.
