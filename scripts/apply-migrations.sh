...
-- $baseline_marker as already applied WITHOUT executing them,
-- skipping the verified holes listed as catch_up in
-- scripts/migration-baseline.conf so they stay pending.
--
