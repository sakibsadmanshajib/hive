...
picker, open Settings, open Workspace), read back out of a Caddy access log,
plus the endpoints other parts of this repo depend on reaching through this
origin (`POST /api/v1/functions/create`, which is how hive_jwt_forward installs,
and its `/api/v1/functions/id/<id>/...` siblings -- see #736).
