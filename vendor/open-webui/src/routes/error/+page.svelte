			...
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					...
					<div class=" mt-4 text-center text-sm w-full">
						...
						<!-- Hive: vendor readme and Discord links removed. A white
						labelled product does not send a customer to another vendor's
						support channel from its own error screen. -->
					</div>
